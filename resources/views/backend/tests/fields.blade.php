<div class="row mt-4 mb-4">
    <div class="col">
        ...
        <div class="form-group row">
            {{ html()->label(__('validation.attributes.backend.tests.full_name'))->class('col-md-2 form-control-label')->for('full_name') }}
            <div class="col-md-10">
                
                        {{ html()->text('full_name')
                        ->class('form-control')
                        ->placeholder(__('validation.attributes.backend.tests.full_name'))
