<div class="row mt-4 mb-4">
    <div class="col">
        ...
        <div class="form-group row">
            {{ html()->label(__('validation.attributes.backend.test2s.l_name2'))->class('col-md-2 form-control-label')->for('l_name2') }}
            <div class="col-md-10">
                
                        {{ html()->text('l_name2')
                        ->class('form-control')
                        ->placeholder(__('validation.attributes.backend.test2s.l_name2'))
